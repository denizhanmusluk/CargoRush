...
public class ShowDesk : Stand
{
    ...
    public override void SpecificStart()
    {
        ...
        ShowCustomerManager.Instance.collectAreaList.Add(_CollectProduct);
        ShowCustomerManager.Instance.maxCharacterCount += customerCount;
    }
    void FishCountInit()
    {
        FishManager.Instance.fishCount[deskID] += fishCountHole;
    }
