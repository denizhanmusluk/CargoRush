...
public class MachineConverter : Stand
{
    ...
    {
        _CollectProducts[0].collectables = woodCollectionList;
        _CollectProducts[1].collectables = plasticCollectionList;
        _CollectProducts[2].collectables = ironCollectionList;
    ...
    IEnumerator CannedCreator()
    {
        ...
        cannedCount = woodCollectionList.Count + plasticCollectionList.Count + ironCollectionList.Count;
        MachineStop();
