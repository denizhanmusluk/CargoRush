...
public class MachineRepairArea : MonoBehaviour
{
    ...
    void RepairListOpen()
    {
        ...
        if (PlayerPrefs.GetInt("firsterrortutorial") == 0)
        {
            ...
            //for(int i = 0; i < 3; i++)
            {
                selectedMachineRepairList.Add(machineRepairListAll[0]);
            }
        }
        else
        {
    ...
    {
        // Rastgele say�lar olu�turmak i�in Random s�n�f�n� kullan�yoruz
        System.Random random = new System.Random();

        // Listeyi rastgele s�raya diziyoruz ve istedi�imiz say�da eleman� al�yoruz
