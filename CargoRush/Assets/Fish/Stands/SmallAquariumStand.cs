...
public class SmallAquariumStand : Stand
{
    ...
    public override void SpecificStart()
    {
        ...
        AquariumCustomerManager.Instance.collectAreaList2.Add(_CollectProduct);
        AquariumCustomerManager.Instance.maxCharacterCount += customerCount;
    }
    void FishCountInit()
    {
