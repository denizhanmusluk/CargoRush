...
public class AquariumCaseManager : MonoBehaviour
{
    private static AquariumCaseManager _instance = null;
    public static AquariumCaseManager Instance => _instance;
    ...
    IEnumerator BoxGo(AquariumCustomer customer)
    {
